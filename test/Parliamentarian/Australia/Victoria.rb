...
describe Parliamentarian::Australia::Victoria do
  ...
  let(:legislative_assemblymembers_csv_filename) do
    File.expand_path(File.join('..', '..', '..', 'fixtures', 'Australia', 'Victoria', 'assemblymembers.csv'), __FILE__)
  end
  let(:legislative_assemblymembers_csv_file) do
    File.read(legislative_assemblymembers_csv_filename)
  end
  ...
  context "HTTP request" do
    ...
    describe ".legislative_assemblymembers" do
      it "retrieves 88 rows" do
        expect(Parliamentarian::Australia::Victoria.legislative_assemblymembers.count).must_equal 88
      end

      it "contains elements of class Parliamentarian::Australia::Victoria" do
        expect(Parliamentarian::Australia::Victoria.legislative_assemblymembers.first.class).must_equal Parliamentarian::Australia::Victoria
      end
    end
  end
  ...
  context "local file" do
    describe ".all" do
      it "retrieves 128 rows" do
        expect(Parliamentarian::Australia::Victoria.all(legislative_councillors_csv_filename, legislative_assemblymembers_csv_filename).count).must_equal 128
      end
    end
    ...
    describe ".legislative_assemblymembers" do
      it "retrieves 88 rows" do
        expect(Parliamentarian::Australia::Victoria.legislative_assemblymembers(legislative_assemblymembers_csv_filename).count).must_equal 88
      end

      it "contains elements of class Parliamentarian::Australia::Victoria" do
        expect(Parliamentarian::Australia::Victoria.legislative_assemblymembers(legislative_assemblymembers_csv_filename).first.class).must_equal Parliamentarian::Australia::Victoria
      end
    end
  end
end
